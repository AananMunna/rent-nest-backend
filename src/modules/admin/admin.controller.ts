...
const updateUserStatus = catchAsync(async (req: Request, res: Response) => {
    ...
    const result = await adminService.updateUserStatus(userId, req.body.activeStatus);
...
const getAllProperties = catchAsync(async (req: Request, res: Response) => {
    const result = await adminService.getAllPropertiesForAdmin(req.query as Record<string, unknown>);
